...
@section('title', 'Tambah Aset IT')
@section('page-title', 'Tambah Aset IT')
@section('page-subtitle', 'Daftarkan perangkat keras atau lunak baru ke inventaris')
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="asset_code" name="asset_code" value="{{ old('asset_code') }}" required placeholder="Contoh: INV-LT-2023-001" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white text-sm transition-colors outline-none">
                    ...
                    <div>
                        ...
                        <input type="text" id="category" name="category" value="{{ old('category') }}" required placeholder="Contoh: Laptop, PC, Printer, dll" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white text-sm transition-colors outline-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" id="brand" name="brand" value="{{ old('brand') }}" required placeholder="Contoh: Lenovo" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white text-sm transition-colors outline-none">
                    ...
                    <div>
                        ...
                        <input type="text" id="model" name="model" value="{{ old('model') }}" required placeholder="Contoh: ThinkPad T14" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white text-sm transition-colors outline-none">
                    ...
                    <div>
                        ...
                        <input type="text" id="serial_number" name="serial_number" value="{{ old('serial_number') }}" required placeholder="SN atau Service Tag" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white text-sm transition-colors outline-none">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" id="purchase_date" name="purchase_date" value="{{ old('purchase_date') }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white text-sm transition-colors outline-none">
                        @error('purchase_date') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label for="status" class="block text-sm font-medium text-slate-700 mb-1.5">Status Awal <span class="text-red-500">*</span></label>
                        <select id="status" name="status" required class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white text-sm transition-colors outline-none">
                            ...
                            <option value="retired" {{ old('status') === 'retired' ? 'selected' : '' }}>Pensiun (Tidak Digunakan Lagi)</option>
                        </select>
                ...
                <div class="p-4 bg-slate-50 rounded-xl border border-slate-100">
                    <p class="text-sm font-semibold text-slate-800 mb-1">Ditugaskan Kepada (Opsional)</p>
                    <p class="text-xs text-slate-500 mb-4">Pilih salah satu: berikan aset kepada user tertentu, atau tugaskan ke seluruh departemen (divisi).</p>
...
@push('scripts')
<script>
    // Logic to ensure only user OR department can be selected, not both. (Though DB can technically support it, UX-wise it's usually mutually exclusive)
